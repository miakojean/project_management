        ...
        <div class="sidebar-footer">
            ...
            <div class="user-profile" @click="toggleProfileMenu">
                <div class="user-avatar">
                    <img src="https://ui-avatars.com/api/?name=Jean+Kouassi&background=3b82f6&color=fff" alt="User">
                </div>
                <div class="user-info">
                    <p class="user-name">Jean Kouassi</p>
                    <p class="user-role">Avocat principal</p>
                </div>
